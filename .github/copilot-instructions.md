...
- Coordinate only genuinely shared deployment, environment, process, port, generated-output, or cloud-resource mutations at that operational boundary. Routine development application deployments are authorized below; Family Dinner never authorizes foundation, production, or other cloud-resource changes and never weakens review, security, privacy, software-approval, rollback, or human-approval requirements.
