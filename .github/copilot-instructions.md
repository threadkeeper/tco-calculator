...
| Frontend quality | ESLint, Prettier, Vitest, and Playwright | Commit `pnpm-lock.yaml`; restore with `pnpm install --frozen-lockfile`; run high-severity audit checks |
