    ...
    fn project(name: &str) -> EditableProject {
        EditableProject {
            ...
            settings: ProjectSettings {
                ...
                default_mi_purchase_option: PurchaseOption::PayAsYouGo,
            ...
            resources: vec![Resource::OnPrem(OnPremResource {
                shared: SharedResource {
                    ...
                    enable_azure_dev_test_pricing: false,
                    enabled: true,
                },
                physical_cores_per_server: 16,
                processors: 2,
                watts_per_server: DecimalValue(Decimal::from(600_u32)),
                hardware_cost_usd: DecimalValue(Decimal::from(10_000_u32)),
                software_cost_usd: DecimalValue(Decimal::ZERO),
                maintenance_cost_usd_per_year: DecimalValue(Decimal::ZERO),
                virtualization_cost_usd_per_year: DecimalValue(Decimal::ZERO),
                datacenter_cost_usd_per_year: DecimalValue(Decimal::ZERO),
                other_cost_usd_per_year: DecimalValue(Decimal::ZERO),
            })],
