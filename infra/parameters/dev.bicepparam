...
param foundryAccountId = readEnvironmentVariable('AZURE_FOUNDRY_ACCOUNT_ID')
param foundryEndpoint = readEnvironmentVariable('FOUNDRY_ENDPOINT')
param foundryModelDeployment = readEnvironmentVariable('FOUNDRY_MODEL_DEPLOYMENT')
...
param calculatorCompanionEnabled = bool(readEnvironmentVariable('CALCULATOR_COMPANION_ENABLED'))
param calculatorCompanionClientId = readEnvironmentVariable('CALCULATOR_COMPANION_CLIENT_ID')
param calculatorCompanionScope = readEnvironmentVariable('CALCULATOR_COMPANION_SCOPE')
param applicationOrigin = readEnvironmentVariable('APPLICATION_ORIGIN')
