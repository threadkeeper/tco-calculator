...
- Status: `passed`
- Case: `ec2/ec2-05`
- Evaluated UTC: `2026-08-21T13:13:00Z`
...
```json
{
  "answer": "Staged a new unsaved EC2 project draft for VM5. Review is required before saving.",
  "classification": {
    "ambiguities": [],
    "confidence": "high",
    "evidence": [
  ...
  "uncertainties": [
    ...
    "The scope of Licence Included requires review.",
